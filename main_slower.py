#Importación de módulos iniciales:
import pandas as pd
import matplotlib.pyplot as plt
from src.functions import *
from src.cleaner_dataset import limpiador
...
try:
    ...
    raise Exception("Fallo al importar CSV")

#Limpieza de dataframe
df5 = limpiador(df)

#Utilización de API gratuita de Twitter:
df5["Contador"] = df5["Nombre"].apply(twitt_counts)

#Cachear los resultador para evitar usos de API innecesarios:
df5.to_csv('Outputs/Twitts_tratados.csv')
